...
config_files = glob.glob(dir_name + '/config/latency_walks*/*.yaml')
count = 0
# for conf in config_files:
for i in missed:
    conf = dir_name + '/config/through_modified_FHUM_5_c_100/through_modified_FHUM_5_c_100_{}.yaml'.format(i)
